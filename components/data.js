...
export const cardsData = [
  { id: 1, title: 'Outdoor getaway', img: 'https://links.papareact.com/2io' },
  { id: 2, title: 'Unique stays', img: 'https://links.papareact.com/q7j' },
  { id: 3, title: 'Entire homes', img: 'https://links.papareact.com/s03' },
  { id: 4, title: 'Pet allowed', img: 'https://links.papareact.com/8ix' },
];
...
export const locationList = [
  ...
  },
  {
    ...
    amenityIds: [
      4, 8, 72, 137, 10, 12, 77, 85, 89, 665, 91, 667, 93, 30, 94, 95, 671, 672,
      33, 35, 103, 40, 104, 44, 236, 45, 46, 47, 308,
    ],
  ...
  },
  {
    ...
    address: 'Paris, Île-de-France, France',
    amenityIds: [
      129, 4, 8, 10, 522, 77, 79, 21, 85, 86, 663, 665, 91, 667, 92, 93, 30, 94,
      95, 671, 33, 34, 35, 36, 37, 103, 167, 40, 104, 42, 107, 44, 236, 45, 46,
      47, 625, 308, 632, 61,
    ],
    previewAmenities: ['Wifi', 'Kitchen', 'Washer', 'Heating'],
    cancelPolicy: 'CANCEL_MODERATE',
  ...
  },
  {
    ...
    address: 'Paris, Île-de-France, France',
    amenityIds: [
      5, 8, 10, 394, 77, 146, 663, 89, 665, 667, 93, 30, 672, 98, 35, 611, 101,
      40, 104, 41, 107, 236, 47, 625, 308,
    ],
  ...
  },
  {
    ...
    amenityIds: [
      ...
      86, 90, 91, 92, 93, 223, 98, 227, 611, 100, 103, 104, 232, 109, 117, 126,
      127,
    ],
    previewAmenities: ['Wifi', 'Heating'],
    cancelPolicy: 'CANCEL_MODERATE',
  ...
  },
  {
    ...
    address: 'Paris, Île-de-France, France',
    amenityIds: [
      1, 2, 4, 8, 10, 12, 77, 146, 85, 86, 663, 89, 90, 93, 30, 94, 31, 96, 33,
      35, 37, 39, 40, 44, 45, 46, 51, 500, 54,
    ],
  ...
  },
  {
    ...
    amenityIds: [
      ...
      667, 93, 30, 94, 95, 287, 671, 96, 672, 33, 35, 611, 100, 40, 104, 42, 44,
      236, 45, 46, 47, 49, 50, 179, 500,
    ],
    previewAmenities: ['Wifi', 'Kitchen', 'Washer', 'Heating'],
    cancelPolicy: 'CANCEL_STRICT_14_WITH_GRACE_PERIOD',
    price: {
